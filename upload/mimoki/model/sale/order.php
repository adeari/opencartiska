...
class ModelSaleOrder extends Model {
	...
	public function editOrderbyName($order_id, $data) {
		$this->load->model('localisation/country');
		...
		if ($order_query->num_rows) {
      	...
      	$this->db->query("UPDATE `" . DB_PREFIX . "order` SET email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', bb = '" . $this->db->escape($data['bb']) . "', hp = '" . $this->db->escape($data['hp']) . "', wa = '" . $this->db->escape($data['wa']) . "',lainnya = '" . $this->db->escape($data['lainnya']) . "', fax = '" . $this->db->escape($data['fax']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_country = '" . $this->db->escape($payment_country) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_zone = '" . $this->db->escape($payment_zone) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_address_format = '" . $this->db->escape($payment_address_format) . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', payment_code = '" . $this->db->escape($data['payment_code']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', shipping_country = '" . $this->db->escape($shipping_country) . "', shipping_country_id = '" . (int)$data['shipping_country_id'] . "', shipping_zone = '" . $this->db->escape($shipping_zone) . "', shipping_zone_id = '" . (int)$data['shipping_zone_id'] . "', shipping_address_format = '" . $this->db->escape($shipping_address_format) . "', shipping_method = '" . $this->db->escape($data['shipping_method']) . "', shipping_code = '" . $this->db->escape($data['shipping_code']) . "', comment = '" . $this->db->escape($data['comment']) . "', order_status_id = '" . (int)$data['order_status_id'] . "', affiliate_id  = '" . (int)$data['affiliate_id'] . "', date_modified = NOW(), name = '". $this->db->escape($data['name'])  ."', payment_name = '". $this->db->escape($data['payment_name'])  ."', shipping_name = '". $this->db->escape($data['shipping_name'])  ."', kecamatan = '".$this->db->escape($data['shipping_kecamatan'])."' WHERE order_id = '" . (int)$order_id . "'");
		if (isset($data['sender_name'])) {
			$this->db->query("UPDATE `" . DB_PREFIX . "order` SET namapengirim = '". $this->db->escape($data['sender_name']) . "', hppengirim ='".$this->db->escape($data['sender_hp']) ."' WHERE order_id = '" . (int)$order_id . "'");
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'shipping_name'      	  => $order_query->row['shipping_name'],
					'sender_name'      	  => $order_query->row['namapengirim'],
					'sender_hp'      	  => $order_query->row['hppengirim'],
				'shipping_kecamatan'      	  => $order_query->row['kecamatan'],
