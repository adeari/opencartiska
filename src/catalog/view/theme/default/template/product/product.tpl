      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <select name="option[<?php echo $option['product_option_id']; ?>]">
            ...
            <option value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $tersedia.' '.$option_value['name']; ?>
            <?php if ($option_value['price']) { ?>
            (<?php echo $option_value['price_prefix']; ?>
            <?php } ?>
            <?php echo $option_value['price']; ?>) <?php echo $tersedia.' '.$option_value['quantity']; ?>
            </option>
            <?php } ?>
          </select>
        </div>
