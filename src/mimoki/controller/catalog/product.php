...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	protected function getFormgampang() {
  		...
  		if (!isset($this->request->get['product_id'])) {
  			$this->data['action'] = $this->url->link('catalog/product/insertgampang', 'token=' . $this->session->data['token'] . $url, 'SSL');
  		} else {
  		...
  		if (isset($this->request->post['price'])) {
  			$this->data['price'] = number_format($this->request->post['price'],0,'','');
  		} elseif (!empty($product_info)) {
  			$this->data['price'] = number_format($product_info['price'],0,'','');
  		} else {
  			$this->data['price'] = '';
  		}
  		...
  		$this->template = 'catalog/product_gampang_form.tpl';
  		$this->children = array(
  				'common/header',
  				'common/footer'
  		);
  	...
  	public function insertgampang() {
  		...
  		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
  			$this->model_catalog_product->addProductgampang($this->request->post);
  	...
  	protected function getList() {				
		...
		$this->data['insert1'] = $this->url->link('catalog/product/gampang', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['button_insert1'] = 'Tambah gampang';	
